...
%   input_files = {'ITA_HRTF_Database/SOFA', 'SADIE_HRTF_Database/hrtf', 'MRT04.sofa', ...
...
for n = 1: size(matching_result, 1)
    ...
    for m = 2: length(temp_cell)
        ...
        idx = ismember(good_hrtf_log, matching_result(n, m));
        output_file_log(k,3) = good_hrtf_log(idx, 2);
        % fill in output log
